...
+(UIBezierPath *)tapTargetForPath:(UIBezierPath *) path{
    CGPathRef tapTargetPath = CGPathCreateCopyByStrokingPath(path.CGPath, NULL, fmax(10.0f, path.lineWidth), path.lineCapStyle, path.lineJoinStyle, path.miterLimit);
